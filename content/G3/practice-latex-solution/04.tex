...
\begin{enumerate}[a)]
  ...
  \item $\psi(\coordvec) = x + y + z, $ az $x + 2y + 4z = 4$ sík
        ...
        Az integrál:
        \begin{align*}
          \int_S g \dd \surfscalar
           & = \int_0^2 \int_0^{y-2} 3 (4 - x - y) \dd x \dd y
          = 3 \int_0^2 \left[ 4x - \frac{x^2}{2} - xy \right]_0^{y-2} \dd y
          \\
           & = 3 \int_0^2 \left( 4(y - 2) - \frac{(y-2)^2}{2} - y (y - 2) \right) \dd y
          = \int_0^2 \left( \frac{-9y^2}{2} + 24y - 30 \right) \dd y
          \\
