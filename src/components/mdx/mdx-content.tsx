    ...
    <Component
      components={{
        ...
        Theorem: (props: any) => {
          ...
          return (
            <div className='border-l-4 border-teal-600 pl-3 pr-2 py-2 bg-secondary-bg/35 my-5 *:last:mb-0 *:first:mt-0'>
              <h4 id={props.id}>
        ...
        BlueBox: (props: any) => (
          <div className='pl-3 pr-2 border-l-4 border-blue-600 py-2 my-5 bg-secondary-bg/35 *:last:mb-0 *:first:mt-0'>
            {props.children}
          </div>
        ),
        Example: (props: any) => (
